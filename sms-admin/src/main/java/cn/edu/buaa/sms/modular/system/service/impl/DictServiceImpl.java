...
import cn.edu.buaa.sms.modular.system.dao.DictMapper;
import cn.edu.buaa.sms.modular.system.model.Dict;
import cn.edu.buaa.sms.modular.system.service.IDictService;
...
import static cn.edu.buaa.sms.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new SmsException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new SmsException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
