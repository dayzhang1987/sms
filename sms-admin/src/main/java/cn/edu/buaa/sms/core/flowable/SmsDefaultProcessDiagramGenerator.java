...
package cn.edu.buaa.sms.core.flowable;
 ...
 */
public class SmsDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public SmsDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public SmsDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
