...
import cn.edu.buaa.sms.core.common.constant.dictmap.MenuDict;
...
import cn.edu.buaa.sms.core.support.BeanKit;
import cn.edu.buaa.sms.core.util.ToolUtil;
import cn.edu.buaa.sms.modular.system.model.Menu;
import cn.edu.buaa.sms.modular.system.service.IMenuService;
import cn.edu.buaa.sms.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new SmsException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new SmsException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
